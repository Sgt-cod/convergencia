...
def montar_video_webdoc_por_capitulos(blocos_roteiro, tema, output_file, largura, altura, orientacao):
    ...
    def _carregar_clip_de_pasta(pasta, largura, altura, manter_audio):
        ...
        clip_bruto = VideoFileClip(caminho).resize(height=altura)
    ...
    vinheta_clip, intro_path = _carregar_clip_de_pasta(f'{ASSETS_DIR}/intro', largura, altura,
                                                         manter_audio=False)
    if vinheta_clip:
    ...
    cta_clip, cta_path = _carregar_clip_de_pasta(f'{ASSETS_DIR}/cta', largura, altura,
                                                   manter_audio=True)
    if cta_clip:
...
def main():
    ...
    try:
        ...
        thumbnail_path = revisar_thumbnail_telegram(thumbnail_path)
